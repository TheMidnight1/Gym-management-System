                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['search-bar'])) {
                                ...
                                $statement =  "SELECT * FROM registration where CONCAT(id,email,firstname,lastname) LIKE '%$filter_value%'";
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <button class="btn btn-primary"><a style="text-decoration:none; color:white;"href="editTrainer.php?trainer_id=<?php echo $items['id']; ?>"> Edit </a></button>
                                                <button class="btn btn-danger"><a style="text-decoration:none;color:white;"href="deleteTrainer.php?trainer_id=<?php echo $items['id']; ?>"> Delete </a></button>
